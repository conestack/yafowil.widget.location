...
TEST_COMMAND?=$(VENV_FOLDER)/bin/pytest src/yafowil/widget/location/tests
...
COVERAGE_COMMAND?=\
	$(VENV_FOLDER)/bin/coverage run \
		...
		-m pytest src/yafowil/widget/location/tests \
...
# Default: locale
GETTEXT_LOCALES_PATH?=src/yafowil/widget/location/locales

# Translation domain to use.
# No default value.
GETTEXT_DOMAIN?=yafowil.widget.location
